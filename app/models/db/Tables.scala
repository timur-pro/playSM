...
// AUTO-GENERATED Slick data model [2019-12-19T23:32:23.662094+03:00[Europe/Moscow]]
...
trait Tables {
  ...
  class SmExif(_tableTag: Tag) extends profile.api.Table[SmExifRow](_tableTag, "sm_exif") {
    ...
    lazy val smFileCardFk = foreignKey("fk_sm_exif_sm_file_card", id, SmFileCard)(r => r.id, onUpdate = ForeignKeyAction.NoAction, onDelete = ForeignKeyAction.NoAction)
  }
  ...
  class SmFileCard(_tableTag: Tag) extends profile.api.Table[SmFileCardRow](_tableTag, "sm_file_card") {
    ...
    /** Index over (sha256,fName) (database name idx_sm_file_card_sha256) */
    val index6 = index("idx_sm_file_card_sha256", (sha256, fName))
  }
